...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
    ...
    if (document.body.scrollTop == 1700 || document.documentElement.scrollTop == 1700) {
        Command: toastr["info"]("Click on Learn more to get more information ", "Info")
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
    ...
    if (document.body.scrollTop == 3200 || document.documentElement.scrollTop == 3200) {
        Command: toastr["info"]("These informations were taken from facebook!", "Info")
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
    ...
    if (document.body.scrollTop == 4000 || document.documentElement.scrollTop == 4000) {
        Command: toastr["info"]("To Contact Them Just Click('Click Here To See His Facebook Profile')", "Info")
